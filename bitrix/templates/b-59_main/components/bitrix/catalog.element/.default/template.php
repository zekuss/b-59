...
$showBuyBtn = in_array('BUY', $arParams['ADD_TO_BASKET_ACTION']) && $arResult['CATALOG_QUANTITY'] > 0;
$buyButtonClassName = in_array('BUY', $arParams['ADD_TO_BASKET_ACTION_PRIMARY']) ? 'btn-default' : 'btn-link';
$showAddBtn = in_array('ADD', $arParams['ADD_TO_BASKET_ACTION']) && $arResult['CATALOG_QUANTITY'] > 0;
                                                    ...
                                                    if ($showAddBtn) {
                                                        ...
                                                        <div class="product-item-info-container product-item-hidden"
                                                            ...
                                                            <div class="product-item-button-container"
                                                                 id="bx_<?= $itemIds['ADD_BASKET_LINK'] ?>_basket_actions">
