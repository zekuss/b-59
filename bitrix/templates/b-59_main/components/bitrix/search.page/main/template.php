...
<div class="search-page">
    ...
    <? elseif (count($arResult["SEARCH"]) > 0): ?>
        ...
        <? foreach ($arResult["SEARCH"] as $arItem): ?>
            <? $arFile = CIBlockElement::GetByID($arItem['ITEM_ID'])->fetch() ?>
            <a href="<? echo $arItem["URL"] ?>" target="_blank">
                <img src="<?= CFile::GetPath($arFile['DETAIL_PICTURE']) ?>"
                                                     class="rounded float-left" height="100px"
                                                     style="margin: 10px"/>
            </a>
