<div id="feedback" class="minic-container">
	<form id="form-feed" class="" method="post">
        <div class="minic-top">
            <h3>{l s='Feedback' mod='minicslider'}
        ...
        <div class="minic-content">
            ...
            <div class="minic-comments"> 
                ...
                <p>{l s='Feel free to give us a feedback about our work (we really like to hear few good words) or write down your idea / request and if we think its good we`ll concider to implement into future versions.' mod='minicslider'}</p>
                ...
                <ul>
                    ...
                    <li>{l s='Your shops domain' mod='minicslider'}: <span>{$minic.info.domain}</span></li>
                    <li>{l s='Prestashop version' mod='minicslider'}: <span>{$minic.info.psVersion}</span></li>
                    <li>{l s='Module version' mod='minicslider'}: <span>{$minic.info.version}</span></li>
                </ul>
            </div>
        </div>
        <div class="minic-bottom">
            <a href="#feedback" id="send-feedback" class="button-large green">{l s='Send' mod='minicslider'}</a>
            <a href="#feedback" class="minic-close button-large lgrey">{l s='Close' mod='minicslider'}</a>
        </div>
	</form>
</div>