...
$MESS["SKGS_SHIPMENT_ID"] = "shipment ID";
$MESS["SKGS_SHIPMENT_DATE"] = "shipment created on";
$MESS["SKGS_SHIPMENT_STATUS"] = "shipment status";
$MESS["SKGS_CHANGING_STATUS_TO"] = "Changing order status to";
$MESS["SKGS_CHANGING_SHIPMENT_STATUS_TO"] = "Change shipment status to ";
...
Thanks for shopping!";
$MESS["SKGS_SHIPMENT_STATUS_MAIL_SUBJ"] = "#SERVER_NAME#: Change status for shipment ##SHIPMENT_ID#";
$MESS["SKGS_SHIPMENT_STATUS_MAIL_BODY1"] = "This message was sent from #SITE_NAME#
";
$MESS["SKGS_SHIPMENT_STATUS_MAIL_BODY2"] = "The status of shipment ##SHIPMENT_ID# has been changed.
";
$MESS["SKGS_SHIPMENT_STATUS_MAIL_BODY3"] = "New shipment status:
";
$MESS["SKGS_SHIPMENT_STATUS_MAIL_BODY4"] = "To view order details, please click here: #SERVER_NAME#/personal/order/#ORDER_ID#/
