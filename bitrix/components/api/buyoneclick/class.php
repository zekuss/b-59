...
class ApiBuyoneclickComponent extends \CBitrixComponent
{
	...
	protected function getProduct()
	{
		...
		$arSelect  = array('ID', 'XML_ID', 'IBLOCK_EXTERNAL_ID');
			...
			if($arProduct) {
				...
				foreach($arOrder['BASKET_ITEMS'] as &$arOneItem) {
					...
					if($arOneItem['DISCOUNT_PRICE'] > 0) {
						$arOneItem['FULL_PRICE'] = PriceMaths::roundByFormatCurrency($arOneItem['BASE_PRICE'] * $arOneItem['QUANTITY'], $arOneItem['CURRENCY']);
