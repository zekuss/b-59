...
$MESS["CP_SPGS_SHOW_FROM_SECTION"] = "Show products in section";
$MESS["IBLOCK_SECTION_ID"] = "Section ID";
$MESS["IBLOCK_SECTION_CODE"] = "Section code";
$MESS["CP_SPGS_SECTION_ELEMENT_ID"] = "Select section for this element ID";
$MESS["CP_SPGS_SECTION_ELEMENT_CODE"] = "Select section for this element symbolic code";
$MESS["CP_SPGS_DEPTH"] = "Maximum visible child sections";
...
$MESS["CP_SPGS_EMPTY"] = "not selected";
$MESS["CP_SPGS_INCLUDE_SUBSECTIONS"] = "Show elements from subsections";
$MESS["CP_SPGS_SHOW_ALL_WO_SECTION"] = "Show all elements if no section is specified";
$MESS["CP_SPGS_SET_BROWSER_TITLE"] = "Set browser window title";
$MESS["CP_SPGS_ADD_SECTIONS_CHAIN"] = "Add Section name to breadcrumb navigation";
$MESS["CP_SPGS_BROWSER_TITLE"] = "Set browser window title from property value";
$MESS["CP_SPGS_CACHE_GROUPS"] = "Respect Access Permissions";
$MESS["CP_SPGS_PRODUCT_QUANTITY_VARIABLE"] = "Product Quantity Parameter Name";
$MESS["CP_SPGS_PRODUCT_PROPS_VARIABLE"] = "Product Properties Parameter Name";
$MESS["CP_SPGS_USE_PRODUCT_QUANTITY"] = "Enable Product Quantity Field";
$MESS["CP_SPGS_ADD_PROPERTIES_TO_BASKET"] = "Pass item and SKU properties to shipping cart";
$MESS["CP_SPGS_PRODUCT_PROPERTIES"] = "Product Properties";
$MESS["CP_SPGS_PARTIAL_PRODUCT_PROPERTIES"] = "Shopping cart can contain items with partially specified properties";
$MESS["CP_SPGS_SECTION_USER_FIELDS"] = "Section Properties";
$MESS["CP_SPGS_OFFERS_FIELD_CODE"] = "SKU Fields";
$MESS["CP_SPGS_OFFERS_PROPERTY_CODE"] = "SKU Properties";
$MESS["CP_SPGS_OFFERS_SORT_FIELD"] = "Sort SKU By Field";
$MESS["CP_SPGS_OFFERS_SORT_ORDER"] = "SKU Sort Order";
$MESS["CP_SPGS_OFFERS_SORT_FIELD2"] = "Second sort field for SKU's";
$MESS["CP_SPGS_OFFERS_SORT_ORDER2"] = "Second sort order for SKU's";
$MESS["CP_SPGS_OFFERS_CART_PROPERTIES"] = "SKU Properties In Shopping Cart";
$MESS["CP_SPGS_CONVERT_CURRENCY"] = "Use only one currency to show prices";
$MESS["CP_SPGS_CURRENCY_ID"] = "Convert all prices to currency";
$MESS["CP_SPGS_OFFERS_LIMIT"] = "Maximum SKU's to Show (use 0 to show all)";
$MESS["CP_SPGS_INCLUDE_SUBSECTIONS_ALL"] = "all subsections";
$MESS["CP_SPGS_INCLUDE_SUBSECTIONS_ACTIVE"] = "active subsections";
$MESS["CP_SPGS_INCLUDE_SUBSECTIONS_NO"] = "don't show";
$MESS["CP_SPGS_HIDE_NOT_AVAILABLE"] = "Unavailable products";
$MESS["CP_SPGS_HIDE_NOT_AVAILABLE_HIDE"] = "don't show";
$MESS["CP_SPGS_HIDE_NOT_AVAILABLE_LAST"] = "move to the bottom";
$MESS["CP_SPGS_HIDE_NOT_AVAILABLE_SHOW"] = "show as usual";
$MESS["CP_SPGS_HIDE_NOT_AVAILABLE_OFFERS"] = "Unavailable SKU's";
$MESS["CP_SPGS_HIDE_NOT_AVAILABLE_OFFERS_HIDE"] = "don't show";
$MESS["CP_SPGS_HIDE_NOT_AVAILABLE_OFFERS_SUBSCRIBE"] = "show as subscribe-to option";
$MESS["CP_SPGS_HIDE_NOT_AVAILABLE_OFFERS_SHOW"] = "show all";
$MESS["CP_SPGS_DISPLAY_COMPARE"] = "Enable product comparison";
$MESS["CP_SPGS_COMPARE_PATH"] = "Product comparison page";
$MESS["CP_SPGS_USE_MAIN_ELEMENT_SECTION"] = "Use main section to show element";
$MESS["CP_SPGS_SET_LAST_MODIFIED"] = "Set page last modified date to response header";
$MESS["CP_SPGS_SECTION_CODE_PATH"] = "Mnemonic codes of nested sections";
$MESS["T_IBLOCK_BACKGROUND_IMAGE"] = "Use property provided background image as background";
$MESS["CP_SPGS_COMPATIBLE_MODE"] = "Enable compatibility mode";
$MESS["CP_SPGS_DISABLE_INIT_JS_IN_COMPONENT"] = "Don't use auxiliary JavaScript libraries";
...
$MESS["CP_SPGS_SET_META_KEYWORDS"] = "Set page keywords";
$MESS["CP_SPGS_SET_META_DESCRIPTION"] = "Set page description";
