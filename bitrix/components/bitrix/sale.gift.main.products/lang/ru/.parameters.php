...
$MESS["SALE_OFFER_ID"] = "ID торгового предложения, по которому выводить товары, к которым торговое предложение является подарком";
$MESS["SALE_ELEMENT_ID"] = "ID элемента, по которому выводить товары, к которым торговое предложение является подарком";
...
$MESS["CP_SGMP_SHOW_SLIDER"] = "Показывать слайдер для товаров";
$MESS["CP_SGMP_SLIDER_INTERVAL"] = "Интервал смены слайдов, мс";
$MESS["CP_SGMP_SLIDER_PROGRESS"] = "Показывать полосу прогресса";
?>