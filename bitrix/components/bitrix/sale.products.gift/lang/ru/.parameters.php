...
$MESS["CP_SPG_SHOW_FROM_SECTION"] = "Показывать товары из раздела";
$MESS["IBLOCK_SECTION_ID"] = "ID раздела";
$MESS["IBLOCK_SECTION_CODE"] = "Код раздела";
$MESS["CP_SPG_SECTION_ELEMENT_ID"] = "ID элемента, для которого будет выбран раздел";
$MESS["CP_SPG_SECTION_ELEMENT_CODE"] = "Символьный код элемента, для которого будет выбран раздел";
$MESS["CP_SPG_DEPTH"] = "Максимальная отображаемая глубина разделов";
...
$MESS["CP_SPG_EMPTY"] = "не выбрано";
$MESS["CP_SPG_INCLUDE_SUBSECTIONS"] = "Показывать элементы подразделов раздела";
$MESS["CP_SPG_SHOW_ALL_WO_SECTION"] = "Показывать все элементы, если не указан раздел";
$MESS["CP_SPG_SET_BROWSER_TITLE"] = "Устанавливать заголовок окна браузера";
$MESS["CP_SPG_ADD_SECTIONS_CHAIN"] = "Включать раздел в цепочку навигации";
$MESS["CP_SPG_BROWSER_TITLE"] = "Установить заголовок окна браузера из свойства";
$MESS["CP_SPG_CACHE_GROUPS"] = "Учитывать права доступа";
$MESS["CP_SPG_PRODUCT_QUANTITY_VARIABLE"] = "Название переменной, в которой передается количество товара";
$MESS["CP_SPG_PRODUCT_PROPS_VARIABLE"] = "Название переменной, в которой передаются характеристики товара";
$MESS["CP_SPG_USE_PRODUCT_QUANTITY"] = "Разрешить указание количества товара";
$MESS["CP_SPG_ADD_PROPERTIES_TO_BASKET"] = "Добавлять в корзину свойства товаров и предложений";
$MESS["CP_SPG_PRODUCT_PROPERTIES"] = "Характеристики товара";
$MESS["CP_SPG_PARTIAL_PRODUCT_PROPERTIES"] = "Разрешить добавлять в корзину товары, у которых заполнены не все характеристики";
$MESS["CP_SPG_SECTION_USER_FIELDS"] = "Свойства раздела";
$MESS["CP_SPG_OFFERS_FIELD_CODE"] = "Поля предложений";
$MESS["CP_SPG_OFFERS_PROPERTY_CODE"] = "Свойства предложений";
$MESS["CP_SPG_OFFERS_SORT_FIELD"] = "По какому полю сортируем предложения товара";
$MESS["CP_SPG_OFFERS_SORT_ORDER"] = "Порядок сортировки предложений товара";
$MESS["CP_SPG_OFFERS_SORT_FIELD2"] = "Поле для второй сортировки предложений товара";
$MESS["CP_SPG_OFFERS_SORT_ORDER2"] = "Порядок второй сортировки предложений товара";
$MESS["CP_SPG_OFFERS_CART_PROPERTIES"] = "Свойства предложений, добавляемые в корзину";
$MESS["CP_SPG_CONVERT_CURRENCY"] = "Показывать цены в одной валюте";
$MESS["CP_SPG_CURRENCY_ID"] = "Валюта, в которую будут сконвертированы цены";
$MESS["CP_SPG_OFFERS_LIMIT"] = "Максимальное количество предложений для показа (0 - все)";
$MESS["CP_SPG_INCLUDE_SUBSECTIONS_ALL"] = "всех подразделов";
$MESS["CP_SPG_INCLUDE_SUBSECTIONS_ACTIVE"] = "активных подразделов";
$MESS["CP_SPG_INCLUDE_SUBSECTIONS_NO"] = "не показывать";
$MESS["CP_SPG_HIDE_NOT_AVAILABLE"] = "Недоступные товары";
$MESS["CP_SPG_HIDE_NOT_AVAILABLE_HIDE"] = "не отображать";
$MESS["CP_SPG_HIDE_NOT_AVAILABLE_LAST"] = "отображать в конце";
$MESS["CP_SPG_HIDE_NOT_AVAILABLE_SHOW"] = "отображать в общем списке";
$MESS["CP_SPG_HIDE_NOT_AVAILABLE_OFFERS"] = "Недоступные торговые предложения";
$MESS["CP_SPG_HIDE_NOT_AVAILABLE_OFFERS_HIDE"] = "не отображать";
$MESS["CP_SPG_HIDE_NOT_AVAILABLE_OFFERS_SUBSCRIBE"] = "отображать только с возможностью подписки";
$MESS["CP_SPG_HIDE_NOT_AVAILABLE_OFFERS_SHOW"] = "отображать все";
$MESS["CP_SPG_DISPLAY_COMPARE"] = "Разрешить сравнение товаров";
$MESS["CP_SPG_COMPARE_PATH"] = "Путь к странице сравнения";
$MESS["CP_SPG_USE_MAIN_ELEMENT_SECTION"] = "Использовать основной раздел для показа элемента";
$MESS["CP_SPG_SET_LAST_MODIFIED"] = "Устанавливать в заголовках ответа время модификации страницы";
$MESS["CP_SPG_SECTION_CODE_PATH"] = "Путь из символьных кодов раздела";
$MESS["T_IBLOCK_BACKGROUND_IMAGE"] = "Установить фоновую картинку для шаблона из свойства";
$MESS["CP_SPG_COMPATIBLE_MODE"] = "Включить режим совместимости";
$MESS["CP_SPG_DISABLE_INIT_JS_IN_COMPONENT"] = "Не подключать js-библиотеки в компоненте";
...
$MESS["CP_SPG_SET_META_KEYWORDS"] = "Устанавливать ключевые слова страницы";
$MESS["CP_SPG_SET_META_DESCRIPTION"] = "Устанавливать описание страницы";
